...
plotter_spatial.py
------------------
Spatial (geographic) plotting methods for StormPlotter.
"""
...
from config import (
    GLOBAL_VAR_CONFIG, EARTH_R_KM, SURFACE_PRESSURE_HPA, 
    DEFAULT_SR_MAX_RANGE, SR_RING_CANDIDATES, RH_RING_CANDIDATES
)

class StormPlotterSpatial(StormPlotterBase):
