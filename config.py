...
GLOBAL_VAR_CONFIG = {
    ...
    'u': {'colorscale': 'RdBu_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Zonal Wind (m/s)', 'sort_order': 1},
    'v': {'colorscale': 'RdBu_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Meridional Wind (m/s)', 'sort_order': 2},
    'w': {'colorscale': 'PuOr_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Vertical Wind (m/s)', 'sort_order': 3},
    't': {'colorscale': 'Plasma', 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Temperature (°C)', 'sort_order': 4},
    ...
    'uerr': {'colorscale': 'RdBu_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Zonal Wind Error (m/s)', 'sort_order': 13},
    'verr': {'colorscale': 'RdBu_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Meridional Wind Error (m/s)', 'sort_order': 14},
    'werr': {'colorscale': 'PuOr_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Vertical Wind Error (m/s)', 'sort_order': 15},
    'terr': {'colorscale': 'Plasma', 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Temperature Error (°C)', 'sort_order': 16},
    'qerr': {'colorscale': 'YlGnBu', 'cmin': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Specific Humidity Error (g/kg)', 'sort_order': 17},
    'perr': {'colorscale': 'Viridis_r', 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Pressure Error (hPa)', 'sort_order': 18},
    'spderr': {'colorscale': 'Turbo', 'cmin': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Wind Speed Error (m/s)', 'sort_order': 19},
    'rvelerr': {'colorscale': 'RdBu_r', 'cmid': 0, 'hide': False, 'is_coord': False, 'is_derived': False, 'display_name': 'Radial Velocity Error (m/s)', 'sort_order': 20},
    ...
    'az': {'hide': True, 'is_coord': True, 'is_derived': False, 'display_name': 'Azimuth (deg)', 'sort_order': 7},
    ...
    'ght': {'colorscale': 'Earth', 'hide': False, 'is_coord': True, 'is_derived': False, 'display_name': 'Geopotential Height (m)', 'sort_order': 10},
    'height': {'colorscale': 'Earth', 'hide': False, 'is_coord': True, 'is_derived': False, 'display_name': 'Height (m)', 'sort_order': 11},
    'altitude': {'colorscale': 'Earth', 'hide': False, 'is_coord': True, 'is_derived': False, 'display_name': 'Altitude (m)', 'sort_order': 12},
    'elev': {'colorscale': 'Earth', 'hide': False, 'is_coord': True, 'is_derived': False, 'display_name': 'Elevation (m)', 'sort_order': 13},
    'rmw': {'hide': True, 'is_coord': True, 'is_derived': False, 'display_name': 'Radius of Max Winds (km)', 'sort_order': 14},
    'time': {'hide': False, 'is_coord': True, 'is_derived': False, 'display_name': 'Time (UTC)', 'sort_order': 15},
...
SHIPS_PREDICTOR_META = {
    ...
    'cohc_kjcm2':     ('kJ/cm2',      'Climatological ocean heat content'),
    ...
    'shdc_kt':        ('kt',          '850-200 hPa vortex-removed shear magnitude'),
    ...
    'nohc_kjcm2':     ('kJ/cm2',      'NCODA ocean heat content'),
}
